...
const createDatabase = async (connectionPromise) => {
    ...
    await connection.exec(
		...
		VALUES(1, 'PIZZA HAWAIENNE', 'hawaian-pizza.jpg', 23),
			(2, 'PIZZA MARGARITA', 'margarita-pizza.jpg', 20),
			(4, 'VEGETERIAN PIZZA', 'vegeterian-pizza.jpg', 20),
			(3, 'BEEF SANDWICH', 'beef-steak-sandwich.jpg', 15),
			(5, 'CHICKEN BURGER', 'chicken-burger.jpg', 15),
			(6, 'CHEESE BURGER', 'double-cheese-burger.jpg', 15);`
    );
